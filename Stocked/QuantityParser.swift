...
struct ParsedQuantity: Equatable, Codable {
...
enum QuantityParser {
    ...
    static func parse(_ raw: String) -> ParsedQuantity {
        ...
        return ParsedQuantity(count: max(0, count ?? 1),
                              container: container,
