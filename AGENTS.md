...
Before editing, read `README_FIRST.md`, then `CROSS_PROJECT_SYNC.md`. Read only relevant README/code sections afterward. Preserve local-first data, images, secrets, shipped compatibility, and unrelated user changes. Verify the affected app/extension path. Update these guides whenever setup or shared contracts change.
